          ...
          <div className="text-center relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                Transform your college activities into valuable credits. Attend
                events, volunteer, join clubs, and redeem amazing rewards from
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <Card
                key={index}
                className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm relative overflow-hidden group"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/80 backdrop-blur-sm"
              >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-unicred-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
            Join thousands of students who are already leveling up their college
            experience with UniCred.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-unicred-600 px-8 py-4 text-lg font-semibold"
            >
              Download App
            </Button>
          </div>
