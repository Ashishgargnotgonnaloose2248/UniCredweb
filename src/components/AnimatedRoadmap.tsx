...
const AnimatedRoadmap = ({ isOpen, onClose }: RoadmapModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
      <Card className="w-full max-w-4xl h-[80vh] bg-white dark:bg-gray-900 border-0 shadow-2xl rounded-3xl overflow-hidden relative">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-6 right-6 z-10 w-10 h-10 bg-white/90 dark:bg-gray-800/90 rounded-full flex items-center justify-center hover:bg-white dark:hover:bg-gray-700 transition-colors shadow-lg"
        >
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="px-8 mb-8">
            <div className="relative">
              ...
              >
                <div className="relative">
                  <div className="text-4xl animate-bounce scale-x-[-1]">🏎️</div>
